...
class _NetG(nn.Module):
    def __init__(self, scale_factor=4, in_c=3, out_c=3, n_feat=80, scale_unetfeats=48, scale_orsnetfeats=32, num_cab=8, kernel_size=3, reduction=4, bias=False):
...
class _NetD(nn.Module):
    def __init__(self,in_c=3):
        ...
        self.features = nn.Sequential(
            ...
            nn.Conv2d(in_channels=in_c, out_channels=64, kernel_size=5, stride=1, padding=2, bias=True),
